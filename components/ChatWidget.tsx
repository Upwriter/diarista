...
const FIRST_MSG: Msg = {
  role: "assistant",
  content: "Oi! Me conta o que você precisa que eu te ajudo a encontrar uma diarista aqui na sua região. 😊",
};
        ...
        >
          ...
          <div className="flex items-center justify-between rounded-t-2xl bg-brand px-4 py-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-sm font-bold text-paper leading-none">Diarista Perto de Mim</p>
                <p className="mt-0.5 text-xs text-paper/70">Assistente virtual</p>
              </div>
            </div>
            <button
